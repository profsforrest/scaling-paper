...
[THIS PARAGRAPH TAKEN FROM REVIEWER 3.]
The paper proposes an unified principle for the emergence of scaling in the metabolic rate in animals and the power consumption of computers, i.e., the design of natural and artificial networks has evolved in a way that minimises energy cost while maximising information flow. This theoretical principle can be used to make testable predictions, e.g., energetic efficiency will change with multi-core processors. This is important for future technological development.
Regarding biological predictions, the current framework extends previous predictions to the observed curvature in metabolic scaling (see Kolokotrones et al., 2010) by including an energy dissipation term.  Other studies have interpreted this deviation as the ‘non-universal’ character of metabolic scaling. The present framework accounts for this deviation and further explains the elevated metabolic rate of largest mammals, which was not addressed in previous models.
The model is consistent with the results of a previous study (Delong et al., 2010) showing how metabolic scaling relationships change at the evolutionary transitions. In this context, the model provides evidence of strong convergence between natural and artificial designs due to physical constraints. This is surprising because there are obvious differences between these two systems. These results might be useful when understanding the emergence of sociality and the transition to complex animal societies.
