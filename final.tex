...
To compare this theoretical prediction to the data, we fit $D_r$ in Equation \ref{eq:OrganismPower} to data taken from~\cite{kolokotrones2010curvature},as shown
in Figure~\ref{fig:OrganismsPowerScaling}.  The best fit to
