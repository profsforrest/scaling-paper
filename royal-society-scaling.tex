...
deviation from a simple linear relationship between metabolism and
mass~\cite{kolokotrones2010curvature}.  While
...
Using data from~\cite{kolokotrones2010curvature}, we can fit the above model
which can be seen in Figure~\ref{fig:OrganismsPowerScaling}. By accounting for
these two terms, each with different scaling exponents, we can account for the
...
the alternative models presented in~\cite{kolokotrones2010curvature}. 
