...
the alternative theoretical models presented
in~\cite{kolokotrones2010curvature} (0.0264 vs 0.0266 for the extended West,
Brown Enquist Model, 0.0276 for the flow-mode proportional transition model,
...
\begin{figure}[!h] \centering
  ...
  \caption{Energy-time minimization model predictions for power
    ...
    Major Axis fits. We include the West, Brown, Enquist~\cite{west97} model in blue to
    accentuate the curvature that our model captures.%Other minimization techniques were tested with
