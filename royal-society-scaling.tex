...
theoretical optimal defined by the model. Both models are fit using Ordinary
Least Squares Regression.We have no reason to believe there are significant
errors in the count of the number of transistors, which would necessitate the
use of Reduced Major Axis(RMA) regression~\cite{mcardle1988structural}.
Regardless, we tested RMA regression and received similar results.
