...
set $D_w$ in order to minimize $E_{net}$.  
...
$Power = \frac{E_{sys}}{T_{sys}} \propto N^{1/2}$.   Second, performance,
measured as computations executed per unit of time, or throughput, is predicted
to scale linearly with $N$,  i.e.  $Throughput\propto \frac{N}{T_{sys}} \propto N$.
