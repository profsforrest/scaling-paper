...
in~\cite{banavar10}, specifically when $D_r=2$, $N\propto M^{\frac{3}{4}}$ and $l_0
\propto N^{\frac{1}{9}}$ and when $D_r=3$, $N\propto M$ and $l_0\propto N^0$.}.
...
presented in Banavar et al.~\cite{banavar2010}. Specifically, we assume that $M
...
total service volume of the animal is $V = \frac{V_{net}}{l_0} \propto
