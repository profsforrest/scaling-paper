...
biologically useful energy in the form of ATP. 
FIXME(Citations needed: banavar?
...
for biology (FIXME: CITE lots of theoretical models).  The first such model~\cite{west97} predicted
scaling relationships by minimizing energy dissipation~\cite{west97},
and a second model focused on
minimizing metabolic delivery time~\cite{banavar10}.  Our model
...
transported.  FIXME(something doesn't compute here.  need to say how
we get from P=RQ to deltaP=RQ). Pressure is the product between hydraulic resistance ($R$) and
